...
export default function powerlineFooter(pi: ExtensionAPI) {
  // Den sub-agents run Pi headlessly for JSON output; keep interactive footer
  // hooks out of those child processes so extension UI warnings don't pollute runs.
  if (process.env.DEN_PI_PARENT_INSTANCE_ID) {
    return;
  }
